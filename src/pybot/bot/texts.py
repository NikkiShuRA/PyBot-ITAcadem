...
from ..core.constants import LevelTypeEnum, RequestStatus, RoleEnum
...
def points_label(points_type: LevelTypeEnum) -> str:
    match points_type:
...
def points_notification(points: Points, points_type: LevelTypeEnum, giver_name: str, reason: str | None) -> str:
